...
# used a local based llm as i didnt had the api key for the open ai.
# if you have the api key for the open ai then you can use the open ai llm as a primary llm for the chatbot 
